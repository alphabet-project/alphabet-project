$(function(){        
    ...
    // var rdc = new Rickshaw.Graph( {
            ...
            // series: [{color: "#33414E",data: seriesData[0],name: 'New'}, 
                     // {color: "#1caf9a",data: seriesData[1],name: 'Retorno'}]
    // } );
    ...
    Morris.Donut({
        ...
        data: [
            {label: "Retorno", value: 2513},
            {label: "Novos", value: 764},
            {label: "Registrados", value: 311}
        ],
